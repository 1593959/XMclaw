...
- [x] `doctor_checks.py` 核心检查 ≥ 8（现 11 条 built-in：config/llm/tools/**workspace**/pairing/port/**events_db**/**connectivity**/**roadmap_lint**/**pid_lock**/daemon；sandbox 留给 Epic #3 — sandbox 运行时落地后再加）

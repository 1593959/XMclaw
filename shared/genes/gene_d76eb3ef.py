"""
When a user reports a bug, automatically initiates a structured bug‑fix workflow: assigns the bug to the appropriate developer, creates a dedicated fix branch, and notifies the team.
...
class BugFixAutomation(GeneBase):
    ...
    async def execute(self, context: dict) -> str:
        ...
        assigned_developer = await self.assign_developer(
            ticket_id=ticket_id,
            component=component
        )
        ...
        branch_result = await self.create_fix_branch(

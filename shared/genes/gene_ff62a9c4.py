"""
Skill that captures user-reported bugs (e.g., “this is broken, please fix error 1”) and automatically creates a bug ticket while alerting the development team.

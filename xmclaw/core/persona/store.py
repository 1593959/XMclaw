...
AUTO_SECTIONS: dict[str, tuple[str, str, str | None] | None] = {
    # IDENTITY.md / BOOTSTRAP.md: NO auto-append from ExtractLessonsHook.
    # Wave-27 fix-12 made them rendered by ``v2_renderer.render_persona_file``
    # from LanceDB facts (bucket=agent_identity for IDENTITY.md).
    # The lesson-hook write path here would compete with the renderer
    # for the same file — leave them manual / renderer-only.
    "IDENTITY.md":  None,
    "BOOTSTRAP.md": None,

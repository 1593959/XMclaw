...
def _default_system_prompt() -> str:
    ...
    _sec_capabilities = (
        ...
        "  - canvas_create / canvas_update / canvas_close: only for a LIVE artifact you intend to mutate across hops (e.g. a chart you update as data streams in). For a one-shot visual in a reply, use the inline fenced block above instead.\n"
        "\n"

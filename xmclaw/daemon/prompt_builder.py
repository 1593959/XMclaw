...
def _default_system_prompt() -> str:
    ...
    return (
        ...
        "  - think: record internal reasoning. Use this whenever you need "
        "to analyze, plan, or reflect before acting. The thought is logged "
        "but NOT shown to the user. NEVER write reasoning as plain text — "
        "always route it through this tool.\n"
        "    CRITICAL: If you output reasoning as plain text in your "
        "response, the user WILL SEE your internal monologue. This is "
        "embarrassing and unprofessional. Use the think tool.\n"
        "    Example of WRONG behavior (DON'T do this):\n"
        "      '用户说...我需要...让我检查一下...' → user sees your thoughts.\n"
        "    Example of RIGHT behavior:\n"
        "      Call think(thought='用户说...我需要...') → user sees NOTHING.\n"
        "      Then output clean content: '好的,我来处理.'\n"

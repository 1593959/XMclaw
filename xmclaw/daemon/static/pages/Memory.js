...
const TAB_LABELS = [
  { id: "facts_v2", label: "L1 事实 (v2)", hint: "Wave 27 — Fact/Relation 结构化事实库。KeyInfoExtractor 即时抓取 URL/账号/目标；LLMFactExtractor 异步提取偏好/决定/身份/承诺/经验教训。默认 top-5 自动注入；关掉 memory.auto_inject.enabled 切换为主动召回（agent 用 memory_search 查询）" },
